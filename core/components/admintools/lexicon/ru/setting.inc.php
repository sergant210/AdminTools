...
$_lang['setting_admintools_check_elements_permissions_desc'] = 'Включает проверку прав на элементы при загрузке дерева. Это замедляет загрузку дерева и потребляем больше памяти.';
...
$_lang['setting_admintools_clear_only resource_cache'] = 'Удалять только кеш ресурса';
